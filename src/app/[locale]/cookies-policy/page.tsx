      ...
      <main className="relative z-10 container mx-auto p-4 md:px-8">
        <div className="bg-white dark:bg-zinc-900 p-8 rounded-[2px] border border-slate-200/70 dark:border-zinc-800 shadow-sm">
          ...
          <div className="space-y-4 text-slate-700 dark:text-zinc-300">
            ...
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-zinc-50 pt-4">{t('whatAreCookies.title')}</h2>
            <p>{t('whatAreCookies.p1')}</p>
            
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-zinc-50 pt-4">{t('howWeUseCookies.title')}</h2>
            <p>{t('howWeUseCookies.p1')}</p>
            
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-zinc-50 pt-4">{t('managingCookies.title')}</h2>
